...
const BusTypeForm: React.FC<Option1FormProps> = ({ onClose }) => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    console.log("Submitting data for option1", { data });
    try {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <h2 className="text-2xl mb-4">Bus Type Form</h2>
      <div className="mb-4">
        <label className="block text-sm font-medium mb-2">Enter Bus Type</label>
        <input
          type="text"
          name="input1"
